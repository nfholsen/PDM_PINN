...
# Data
data_dir = '../../../../../Training_Data/Moseley_Crack_1/'
data_csv = '../../../../../Training_Data/Moseley_Crack_1_Train.csv'
velocity_field = '../../../../../Training_Data/Velocity_Field_Crack_1.npy'
...
class UNetModel(BaseModel):
    def __init__(self, net, opt=None, sched=None, logger=None, print_progress=True, device='cuda:0'):
        ...
        self.loss_fn = MSLoss(*[PINNLoss_RES(dh=5, dt=0.002, c=torch.Tensor(training_data.velocity_field_values)[None,None].to(device))])
    ...
    def forward_loss(self, data):
        ...
        return loss[0], {'Loss':loss[0], 'Loss PINN RES':loss[1]} # Elements in the dict : only for printing
